<%@ page import="linksharing.GlobalResource linksharing.GlobalUser linksharing.Topic.Visibility linksharing.Subscription.Seriousness linksharing.DocumentResource linksharing.LinkResource linksharing.GlobalResource linksharing.Topic linksharing.Subscription linksharing.GlobalUser" %>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-5">
            <div class="col-12 mt-3 ml-2 leftCol2">
                <div class="col-12 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4 centerAl">
                                                        ${linksharing.GlobalResource.countByTopics(t)}
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    %{--<div class="col-4 ">--}%
                                                        %{--<g:form controller="subscription" action="changeSeriousness" params="[id: t.id]">--}%
                                                            ...
                                                            %{--<select class="form-control form-control-sm" name="serious" onchange="this.form.submit()">--}%
                                                                %{--<g:if test="${Subscription.findByTopicAndUser(t,u).seriousness== Seriousness.SERIOUS}">--}%
                                                                    %{--<option value="casual">Casual</option>--}%
                                                                    %{--<option value="serious" selected>Serious</option>--}%
                                                                    %{--<option value="very serious">Very serious</option>--}%
                                                                %{--</g:if>--}%

                                                                %{--<g:elseif test="${Subscription.findByTopicAndUser(t,u).seriousness== Seriousness.CASUAL}">--}%
                                                    ...
                                                    <div class="col-4 selects">
                                                        <g:form controller="topic" action="changePrivacy"  params="[id: t.id]">
                                                            <g:if test="${t.visibility== Topic.Visibility.PRIVATE}">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                <a href="#" data-toggle="modal" data-target="#sendInvitations" data-val="${t.topicname}">
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                %{--                                                                <g:link controller="topic" action="delete" params="[id:Subscription.findByTopic(t).id]">--}%
            ...
            <div class="col-12 mt-3 ml-2 mb-2 leftColName">
                ...
                %{--<div class="col-12">--}%
                    %{--<g:each in="${Subscription.findAllByTopic(t)}" var="num">--}%
                        %{--<div class="row">--}%
                            ...
                            %{--<div class="col-8">--}%
                                ...
                                %{--<div class="col-12 mt-2">--}%
                                    ...
                                    %{--<div class="row">--}%
                                        %{--<div class="col-6 topic">--}%
                                            %{--${Subscription.countByUser(num.user)}--}%
                                        %{--</div>--}%

                                        %{--<div class="col-6 topic">--}%
                                            %{--${Topic.countByCreatedBy(num.user)}--}%
                                        %{--</div>--}%
                                    %{--</div>--}%
        ...
        <div class="col-6 ml-5 mt-3 rightColInbox">
            <div class="col-12">
                <nav class="navbar">
                    <h4>INBOX: ${t.topicname}</h4>
                </nav>
            </div>
            %{--<g:if test="${Subscription.findByTopicAndUser(t,u)}">--}%
                %{--<div class="row">--}%
                    %{--<div class="col-12">--}%

                        %{--<table class="table mb-0">--}%
                            %{--<tbody>--}%
                            %{--<g:each in="${Resource.list()}" var="res">--}%
                                %{--<g:if test="${res.topic.name == t.name}">--}%
                                    %{--<tr>--}%
                                        %{--<td>--}%
                                            %{--<div class="col-12 ">--}%
                                                        ...
                                                        %{--<div class="col-12  mt-4">--}%
                                                            %{--<div class="row">--}%
                                                                ...
                                                                %{--<div class="col-9 links">--}%
                                                                    ...
                                                                    %{--<g:else>--}%
                                                                        %{--<a href="${LinkResource.findById(res.id).url}" class="links1">View Full Site</a>--}%
                                                                    %{--</g:else>--}%
