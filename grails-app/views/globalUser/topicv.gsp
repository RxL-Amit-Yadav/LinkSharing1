...
<main>
    <div class="container-fluid ">
        <nav class=" navbar heading rounded-top"><span><STRONG>Topic List</STRONG></span></nav>
        <div style="border: 3px solid black">
            <table class="table table-striped mb-0" id="myTable">
                ...
                <tr>
                    ...
                    <th scope="col" onclick="w3.sortHTML('#myTable','.item', 'td:nth-child(2)')" style="cursor:pointer">Topicname</th>
                    <th scope="col" onclick="w3.sortHTML('#myTable','.item', 'td:nth-child(3)')" style="cursor:pointer">CreatedBy</th>
                    <th scope="col" onclick="w3.sortHTML('#myTable','.item', 'td:nth-child(4)')" style="cursor:pointer">Visibility</th>
                    %{--<th scope="col" onclick="w3.sortHTML('#myTable','.item', 'td:nth-child(5)')" style="cursor:pointer">Update</th>--}%
                    <th scope="col" onclick="w3.sortHTML('#myTable','.item', 'td:nth-child(6)')" style="cursor:pointer">Update</th>
                </tr>
                </thead>
                <tbody>
                <g:each in="${linksharing.Topic.list()}" var="u">
                    <tr class="item">
                        <td>${u.id}</td>
                        <td>${u.topicname}</td>
                        <td>${u.globalUser.firstname}</td>
                        <td>${u.visibility}</td>
                        <td><g:link controller="topic" action="delete" params="[id:u.id]">Delete</g:link></td>
