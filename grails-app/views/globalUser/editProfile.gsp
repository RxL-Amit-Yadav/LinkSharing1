...
<main id="main-section">
    ...
    <div id="recent-share">
        <h4 style="background-color: lightgrey">Update Profile</h4>
        <div class="recent-share-half">

            <g:form controller="user" action="updateProfile" class="signup">
                <div class="field">
        ...
        <h4 style="background-color: lightgrey">Change Password</h4>
        <div class="recent-share-half">
